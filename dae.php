...
class dae {
    private $job;
    public const PROCESS_NAME = 'ddns';
    public const MAXCONN = 2048;
    public const PIDNAME = __CLASS__;
    public const uid = 80;
    public const gid = 80;
    protected $pool = NULL;
    public $pidfile;
...
// we are the child
    ...
    private function help($proc): void {
    ...
    public function handle($instance, $channelName, $message): void {
        file_put_contents(__DIR__ . "/$channelName.txt", $message . "\n", FILE_APPEND);
    }

    public function signoH($signo): void {
        switch ($signo) {
            case SIGHUP :
